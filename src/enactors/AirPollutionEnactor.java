...
public class AirPollutionEnactor extends Enactor {
	...
	public AirPollutionEnactor(AbstractQueryItem<?,?>[] inWidgetQuery, AbstractQueryItem<?,?>[] outWidgetQuery) {
		...
		AbstractQueryItem<?, ?> warningQI = new ORQueryItem(
				RuleQueryItem.instance(
						new NonConstantAttributeElement(AttributeNameValue.instance(AirPollutionWidget.AIR_POLLUTION, AIR_POLLUTION_THRESHOLD)), 
	...
	private class AmbientEnactorReference extends EnactorReference {
		...
		public AmbientEnactorReference(AbstractQueryItem<?,?> conditionQuery, Boolean outcomeValue) {
			super(AirPollutionEnactor.this, conditionQuery, outcomeValue.toString());
		}
