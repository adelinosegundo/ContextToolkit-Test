...
public class AirPollutionWarningService extends Service {
	public JTextArea warningTextArea;

	@SuppressWarnings("serial")
	public AirPollutionWarningService(final Widget widget) {
		super(widget, "AirPollutionWarningService", 
...
String warning_value = String.valueOf(serviceInput.getInput().getAttributeValue(WarningWidget.WARNING_AIR_POLLUTION));
